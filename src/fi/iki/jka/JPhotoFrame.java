...
public class JPhotoFrame extends JFrame
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (cmd.equals(JPhotoMenu.A_NEW) || cmd.equals(JPhotoMenu.A_OPEN)) {
            ...
            MessageShower realDialog = new RealMessageShower();

            new SlideshowControl().showSlideshow(this, photos, list, realDialog);
        }
    ...
    */
    ...
    private class RealMessageShower implements MessageShower {
